...
let LicenseRepository = class LicenseRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.License, dataSource);
    }
};
LicenseRepository = tslib_1.__decorate([
