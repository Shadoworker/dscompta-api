...
let ArchiveRepository = class ArchiveRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource, userRepositoryGetter, companyRepositoryGetter) {
        super(models_1.Archive, dataSource);
...
ArchiveRepository = tslib_1.__decorate([
